...
public class EventListActivityAdminViewOnly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(EventListActivityAdminViewOnly.this, MainActivityAdmin.class);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(R.menu.event_context_menu_view_admin, menu);
    }
    ...
    private void doViewDetails(Event selectedEvent) {
        ...
        Intent intent = new Intent(getApplicationContext(), EventDetailsActivityAdminViewOnly.class);
